...
namespace SpotHunt
{
		public class Playfield
		{
			...
			public List<GoalSpot> goals;
			public int width = 0;
			public int height = 0;
			public MovingSpot spot;
		 ...
		 * @since 1.0
		 */
			public void setGoals(List<GoalSpot> goals) {
				this.goals = goals;
			}
		 ...
		 */
			public void getInformation() {
				...
				for(int i = 0; i < players.Count; i++) {
					Console.WriteLine("Player " + i + ": " + players[i].toString());
				}
				// Show the information of the moving spot
					Console.WriteLine("Spot: " + spot.toString());
				// Show the information for each goal spot
				for(int i = 0; i < goals.Count; i++) {
					Console.WriteLine("Goal "+ i + ": " + goals[i].toString());
				}
			}
